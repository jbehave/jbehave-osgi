...
public class StoryRunnerServiceFactoryComponent extends AbstractComponent
		implements StoryRunnerService,
		Comparable<StoryRunnerServiceFactoryComponent> {
	...
	private String storyBundleVersion = "";
	...
	protected void activate(ComponentContext context) {
		...
		if (embedder != null) {
			logDebug("An Story Runner Service factory component instance was activated for: "
					+ getStoryClassName() + " from bundle: " + storyBundleName);
		}
	}
	...
	private void buildConfiguration(EmbedderOsgi embedder) {
	...
	private EmbedderOsgi buildEmbedder(Bundle ownerBundle) {
	...
	@Override
	public int compareTo(StoryRunnerServiceFactoryComponent o) {
		return this.getStoryClassName().compareTo(o.getStoryClassName());
	}
	...
	public boolean equals(Object obj) {
		...
		StoryRunnerServiceFactoryComponent other = (StoryRunnerServiceFactoryComponent) obj;
	...
	public String getStoryBundleName() {
		return storyBundleName;
	}

	@Override
	public String getStoryBundleVersion() {
		return storyBundleVersion;
	}
	...
	private void initializeEmbedder(ComponentContext context) {
		Object storyBundleNameObj = getProperties().get(
				Constants.EXTENDEE_BUNDLE);
		storyBundleName = storyBundleNameObj != null ? (String) storyBundleNameObj
				: "no defined";

		Object storyBundleVersionObj = getProperties().get(
				Constants.EXTENDEE_BUNDLE_VERSION);
		storyBundleVersion = storyBundleVersionObj != null ? (String) storyBundleVersionObj
				: "no defined";

		Object storyClassNameObj = getProperties().get(
				Constants.STORY_RUNNER_EXTENDER_PROPERTY_ITEM);
		storyClassName = storyClassNameObj != null ? (String) storyClassNameObj
				: "no defined";
		...
		setOwnerBundle(searchOwnerBundle(context.getBundleContext(),
				storyBundleName, storyBundleVersion));
		...
		storyClass = loadClass(storyClassName, Object.class);
