...
class DefaultExtensionTracker extends BundleTracker<Object> {
	...
	private final AbstractExtenderComponent extendableComponent;
	private final List<String> contributions = new CopyOnWriteArrayList<String>();

	public DefaultExtensionTracker(AbstractExtenderComponent extendableComponent,
	...
	public AbstractExtenderComponent getExtendableComponent() {
