...
public abstract class AbstractPaxExamForStoryRunner {
	...
	public void beforeSetup() throws InvalidSyntaxException,
		...
		Assert.assertNotNull("Any runner service was registered", services2Run);
		Assert.assertEquals("Any runner service was registered.",
				services2Run.isEmpty(), false);
	}
	...
	public Option[] config() {
		...
		return options(systemProperty("eclipse.consoleLog").value("true"),
	...
	public synchronized void runAllServices() throws Throwable {
		...
		Assert.assertNotNull(
				"No StoryRunnerService registered was found to be executed.",
				services2Run);
		synchronized (services2Run) {
