...
public abstract class AbstractCommonTest {
    ...
    private UrlProvisionOption buildEmbedderExtendeeBundle() {
        return streamBundle(TinyBundles
                ...
                .set(IMPORT_PACKAGE,
                        "org.jbehave.osgi.core.itests.lib.steps,org.apache.commons.lang;version=\"[2.6,3)\",org.junit,org.osgi.framework;version=\"[1.6,2)\",com.thoughtworks.paranamer")
                .set(REQUIRE_BUNDLE,
    ...
    private UrlProvisionOption buildInjectableStepsFactoryExtendeeBundle() {
        return streamBundle(TinyBundles
                ...
                .set(IMPORT_PACKAGE,
                        "org.apache.commons.lang;version=\"[2.6,3)\",org.junit,org.osgi.framework;version=\"[1.6,2)\",com.thoughtworks.paranamer")
    ...
    public Option[] config() {
        ...
        return options(systemProperty("osgi.debug").value("true"),
                systemProperty("osgi.console").value("true"),
    ...
    public void ensureJBehaveBundlesAreActive() {
        ...
        assertBundleState(Bundle.ACTIVE, "org.knowhowlab.osgi.testing.utils",
                5, TimeUnit.SECONDS);
        assertBundleState(Bundle.ACTIVE, "org.hamcrest.integration",
