...
public class View extends ViewPart {
	...
	public static final String ID = "org.jbehave.osgi.examples.rcpmail.application.view";
	...
	public void createPartControl(Composite parent) {
		...
		setPartName(getViewSite().getRegisteredName()
				+ (getViewSite().getSecondaryId() != null ? Integer
						.parseInt(getViewSite().getSecondaryId()) + 1 : ""));
