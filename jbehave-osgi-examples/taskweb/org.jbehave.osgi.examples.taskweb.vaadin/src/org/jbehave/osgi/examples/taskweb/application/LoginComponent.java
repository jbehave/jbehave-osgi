...
public class LoginComponent extends CustomComponent {
    ...
    static {
        try {
            ON_LOGIN_METHOD = LoginAttemptListener.class.getDeclaredMethod("onLoginEvent",
	 ...
	 * @param listener
	 */
	public void addListener(LoginAttemptListener listener) {
	 ...
	 * @param listener
	 */
	public void removeListener(LoginAttemptListener listener) {
